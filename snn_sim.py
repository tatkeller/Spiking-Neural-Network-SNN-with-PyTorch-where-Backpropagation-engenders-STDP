...
spiking_model = SpikingNet(device, n_time_steps=int(128/2), begin_eval=0)
train_many_epochs(spiking_model, epochs = 15)

non_spiking_model = NonSpikingNet().to(device)
train_many_epochs(non_spiking_model, epochs = 15)
